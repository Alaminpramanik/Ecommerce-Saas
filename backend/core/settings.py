...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-default-key-change-this-in-prod')
...
PATHAO_CLIENT_SECRET = env('PATHAO_CLIENT_SECRET', default='')
STEADFAST_API_KEY = env('STEADFAST_API_KEY', default='')
REDX_API_TOKEN = env('REDX_API_TOKEN', default='')
